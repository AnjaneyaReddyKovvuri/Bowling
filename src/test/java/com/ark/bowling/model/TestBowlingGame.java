...
public class TestBowlingGame {
    ...
    public void testFrameScores(List<Integer> throwScores, List<Integer> expectedFrameScores, int totalLaneScore, boolean isGameOver) {
        ...
        game.getLanes()[0].printLane();
        System.out.println(game.isGameOver());
        assertEquals(game.isGameOver(),isGameOver);
        assertArrayEquals(game.getLanes()[0].getLaneCalculatedScores().toArray(),expectedFrameScores.toArray());
    }
}
