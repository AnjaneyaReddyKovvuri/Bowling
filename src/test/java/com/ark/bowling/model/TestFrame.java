...
public class TestFrame {
	...
	@DataProvider
	public static Object[] frameData() {
		return new Object[][] { 
			{ Arrays.asList(5, 5), 10 , false, true, true },
			{ Arrays.asList(3, 7), 10 , false, true, true },
			{ Arrays.asList(0, 1), 1 , false, false, true}, 
			{ Arrays.asList(0, 0), 0, false, false , true},
			{ Arrays.asList(0, 10), 10, false, true , true},
			{ Arrays.asList(10), 10 , true, false, true},
			{ Arrays.asList(7), 7 , false, false, false} 
		};
	}

	@Test
	@UseDataProvider("frameData")
	public void testFrame(List<Integer> scores, Integer frameScore, boolean isStrike, boolean isSpare, boolean isComplete) {
